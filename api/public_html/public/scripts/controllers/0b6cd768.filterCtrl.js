            ...
            $scope.filterSearch = function(query, i) {
                ...
                if (query == "mostRecent") {
                    $http.get($rootScope.urlRoot + '/bills/recent').success(function(data) {
                        ...
                        console.log('filter most recent number of results: ' + $rootScope.numberOfResults);
                    ...
                    $http.get($rootScope.urlRoot + '/bills/search/?bill="' + query + '"&per_page=5').success(function(data) {
                        ...
                        $rootScope.lastSearch = query;
                        console.log($rootScope.lastSearch);
                        $rootScope.numberOfResults = data.count;
                        console.log('filter number of results: ' + $rootScope.numberOfResults);
