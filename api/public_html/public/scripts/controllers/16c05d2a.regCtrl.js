    ...
    function($scope, $http, $rootScope, $location, alertService, Auth) {
        ...
        $scope.finishedWizard = function() {
            ...
            $scope.filters = [{
                ...
                "show": $scope.$$childTail.interest.lawEnforcement,
                "query": "law enforcement"
            }, {
                "name": "Education",
                "show": $scope.$$childTail.interest.education,
                "query": "education"
            }, {
                "name": "Health Care",
                "show": $scope.$$childTail.interest.healthCare,
                "query": "health care"
            }, {
                "name": "Veterans",
                "show": $scope.$$childTail.interest.veterans,
                "query": "veterans"
            }, {
                "name": "Children",
                "show": $scope.$$childTail.interest.children,
                "query": "children"
            }, {
                "name": "Minorities",
                "show": $scope.$$childTail.interest.minority,
                "query": "minority"
            }, {
                "name": "Foreign Aid",
                "show": $scope.$$childTail.interest.foreignAid,
                "query": "foreign aid"
            }, {
                "name": "Immigration",
                "show": $scope.$$childTail.interest.immigration,
                "query": "immigration"
            }, {
                "name": "Taxes",
                "show": $scope.$$childTail.interest.taxes,
                "query": "taxes"
            }, {
                "name": "Defense Spending",
                "show": $scope.$$childTail.interest.defenseSpending,
                "query": "defense spending"
            }, {
                "name": "Privacy",
                "show": $scope.$$childTail.interest.privacy,
                "query": "privacy"
            }, {
                "name": "Disaster Relief",
                "show": $scope.$$childTail.interest.disasterRelief,
                "query": "disaster relief"
            }, {
                "name": "Religion",
                "show": $scope.$$childTail.interest.religion,
                "query": "religion"
            }, {
                "name": "Women's Rights",
                "show": $scope.$$childTail.interest.abortion,
                "query": "abortion"
            }, {
                "name": "LGBT",
                "show": $scope.$$childTail.interest.lgbt,
                "query": "lgbt"
            }];
            //console.log('filters');
            ...
            swal({
                ...
                function() {
                    swal("Success!", "Check your email, verify, and then log in.", "success");
        ...
        $scope.updateGeneralInfo = function() {
            ...
            if ($scope.$$childTail.sex) {
                $scope.validSex = true;
                // console.log($scope.$$childTail.sex);
                // console.log($scope.validSex);
                // console.log($scope.$$childTail.validStepOne);
            }
