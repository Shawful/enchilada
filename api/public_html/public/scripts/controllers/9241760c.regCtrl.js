...
app.controller('regCtrl', ['$scope', '$http', '$rootScope',
    function($scope, $http, $rootScope) {
        ...
        $scope.updateGeneralInfo = function() {
            ...
            //console.log($scope);
            $scope.$$childTail.validStepOne = $scope.validFirstName && $scope.validLastName && $scope.validEmail 
            && $scope.validPassword && $scope.validAge && $scope.validSex && $scope.validTOS;
        };
