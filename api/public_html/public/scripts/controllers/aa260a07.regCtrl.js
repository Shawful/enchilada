 ...
 */
app.controller('regCtrl', ['$scope', '$http', '$rootScope', '$location', 'alertService', 
        ...
        $scope.finishedWizard = function() {
            ...
            var registerUserConfig = {
                ...
                data: {
                    ...
                    "interest": $scope.$$childTail.interest
                    // {
            ...
            $http(registerUserConfig).success(function(data) {
                ...
                $('#registrationModalContainer').modal({show: false});

                // redirect to login
                //$location.path('/login');

                // eventually redirect to home page and log user in automatically
