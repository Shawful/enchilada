...
angular.module('politicheckApp')
	.factory('Auth', ['$http', '$rootScope', '$cookieStore', '$location', 'alertService',
        ...
        $http(loginConfig).success(function(data){
            ...
            $rootScope.user = {'username': user.username, 'authtoken': $authToken};
            $rootScope.user = user;
            ...
            //can't currently broadcast a message that someone has logged in?!
            //$rootScope.$broadcast('login_error', "Welcome to EasyBallot, " + $rootScope.user.username);
